...
<div class="row">
    ...
    <form>
        <div class="form-group">
            <label>Id</label>
            <input type="text" name=Id readonly="readonly" value="<?php echo $dados["disciplinaId"]; ?>" class="form-control"/>
        </div>
        ...
        <div class="form-group">
            <label>Sigla</label>
            <input type="text" name=sigla value="<?php echo $dados["sigla"]; ?>" class="form-control"/>
        </div>

        <div class="form-group">
            <label>Apelido</label>
            <input type="text" name=apelido value="<?php echo $dados["apelido"]; ?>" class="form-control"/>
        </div>
